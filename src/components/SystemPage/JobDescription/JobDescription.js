...
export default function JobDescription({ selectID,select, Open, setOpen, trigger }) {
                    ...
                    <Toolbar >
                        <Grid container justify='space-between' alignItems='baseline'>
                            ...
                            <Grid item>
                                <Typography variant='body1'>
                                    {select ?
                                        trigger == 'onet' ? select.職位名稱 : trigger == 'taiwan' ? select.台灣職位名稱 : null
                                        : null
                                    }
                                </Typography>
                            </Grid>
                ...
                </AppBar>
                {
                    trigger == 'onet' ?
                        <>
                            <Box p={4}>
                                <Grid container style={{ paddingTop: 56 }}>
                                    <Grid item xs={12}><Typography component='p' variant='h6' color='primary'>{`職位描述 (${selectID})`}</Typography></Grid>
                            ...
                            {select?select.問卷重複[0]? 
                            <Box pl={4} pr={4} pb={4} >
                                <Grid container>
                                    <Grid item xs={12}><Typography component='p' variant='h6' color='primary'>重複問卷</Typography></Grid>
                                    <Grid item xs={12}><Divider style={{ marginTop: 5, marginBottom: 10 }} /> </Grid>
                                    <Grid item xs={12}>

                                        <Box >

                                            {select.問卷重複.map(item =>
                                                <Chip
                                                    size="small"
                                                    label={item}
                                                    onClick={()=>{}}
                        ...
                        <>
                            ...
                            <Box pl={4} pr={4} pt={2}>
                                <Grid container >
                                    <Grid item xs={12}><Typography component='p' variant='h6' color='primary'>職位工作內容</Typography></Grid>
                                    <Grid item xs={12}><Divider style={{ marginTop: 5, marginBottom: 10 }} /> </Grid>
                                    <Grid item xs={12}>

                                        <Box >
                                            {select ? select.職位工作內容.map((item, index) => {
